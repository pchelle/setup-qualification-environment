...
#' @description
#' This script installs the OSPSuite and Qualification tools
#' @param tools.csv csv file describing the versions of software tools used to install
#' @author [Open Systems Pharmacology](https://github.com/Open-Systems-Pharmacology)

# Checks if tools.csv exists and can be read:
print(list.files())
